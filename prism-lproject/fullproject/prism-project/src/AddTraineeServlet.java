...
//        pstmt.setString(5, wemail);
        ...
        pstmt.setString(8, docpath);
        pstmt.setString(9, photopath);
        pstmt.setString(10, mob1);
        pstmt.setString(11, mob2);
        int n = pstmt.executeUpdate();
        if(n>0)
        {
        	RequestDispatcher rd = req.getRequestDispatcher("traineesuccess.html");
        	rd.forward(req, res);
        }
        else
        {
        	System.out.println(n);
        	RequestDispatcher rd = req.getRequestDispatcher("traineefailure.html");
        	rd.forward(req, res);
        }
    }
    catch(Exception e)
